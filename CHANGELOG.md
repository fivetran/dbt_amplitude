# dbt_amplitude v1.4.1

[PR #44](https://github.com/fivetran/dbt_amplitude/pull/44) includes the following updates:

## Feature Updates
- Adds DuckDB as a supported destination.


# dbt_amplitude v1.4.0

[PR #42](https://github.com/fivetran/dbt_amplitude/pull/42) includes the following updates:
...
- Adds the `fivetran_using_source_casing` variable for case-sensitive destination support. When enabled, downstream transformations respect source casing to ensure consistent results. See the [Additional Configurations](https://github.com/fivetran/dbt_amplitude/#source-casing-for-case-sensitive-destinations) section of the README for details.
...
- Adjusts the data type of `amplitude__date_range_start` in the `quickstart.yml` from string to date.
