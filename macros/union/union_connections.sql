{% macro amplitude_union_connections(connection_dictionary, single_source_name, single_table_name, default_identifier=single_table_name) %}

{{ adapter.dispatch('amplitude_union_connections', 'amplitude') (connection_dictionary, single_source_name, single_table_name, default_identifier) }}

{%- endmacro %}

{% macro default__amplitude_union_connections(connection_dictionary, single_source_name, single_table_name, default_identifier=single_table_name) %}
...
{# For unioning #}
    ...
    {%- if relations != [] -%}
        {{ amplitude.amplitude_union_relations(relations) }}
