{{
    config(
        ...
        partition_by={"field": "session_started_at_day", "data_type": "timestamp"} if target.type not in ('!!!!!!! REPLACE 'spark' WITH 'spark','databricks' OR EQUIV !!!!!!!','databricks') else ['session_started_at_day'],
